...
function SeeQuestions(props) {
  ...
  return (
    <div className="seeQuestionsDiv">
      ...
      <button
        style={{ marginRight: "1%" }}
        className="TeacherViewButton btn btn-secondary btn-block"
      ...
      <button className="TeacherViewButton btn btn-secondary btn-block" onClick={handleDelete}>
        Delete
      </button>
    </div>
  );
...
function TeacherViewUpdate() {
  ...
  return (
    <div>
      <h1 style={{ textAlign: "center" }} className="my-5">Update a question</h1>
      <Select
